...
def predict():
    ...
    if State_Name==29 and Crop==111 or State_Name==32 and Crop==111 or State_Name==1 and Crop==111 or State_Name==30 and Crop==96 or State_Name==27 and Crop==96 or State_Name==31 and Crop==96:
        prediction=0
        return render_template('index.html',
                                   prediction_text='crop production prediction {} tonne because this crop is not grown in this state'.format(prediction),
                                   state='State_Name :{}'.format(State_Name1),
